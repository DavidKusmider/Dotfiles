...
local servers = {
    ...
    --     cmd = { "jdtls" },
    --     filetypes = { "java" },
    --     -- Autres options de configuration spécifiques à JDTLS
    -- },
    lua_ls = {},
    prismals = {},
    rust_analyzer = {},
...
-- Configuration globale pour tous les serveurs
...
require("lspconfig").jdtls.setup{
  cmd = { "jdtls" },  -- Le chemin vers l'exécutable jdtls, peut varier en fonction de votre installation
  filetypes = { "java" },  -- Les types de fichiers pour lesquels le serveur JDTLS sera activé
  root_dir = require("lspconfig/util").root_pattern("pom.xml", "gradle.build"),  -- Le motif de recherche du répertoire racine du projet Java
  on_attach = function(client, bufnr)
    -- Configuration personnalisée à exécuter lors de l'attachement du client LSP
    -- Par exemple, vous pouvez configurer des mappages et d'autres préférences ici
  end,
}
--
-- require("lspconfig").jdtls.setup{}
-- require'lspconfig'.jdtls.setup{}
-- -- local capabilities = vim.lsp.control.make_client_capabilities()
-- capabilities = require("cmp_nvim_lsp").default_capabilities(capabilities)
--
-- require("lspconfig")["clangd"].setup({
-- 	on_attach = on_attach,
